...
import { Share2, Copy, Users, Gift, Sparkles, ChevronRight } from "lucide-react";
...
const ReferralSystem: React.FC<ReferralSystemProps> = ({
  ...
  const handleInviteFriend = () => {
    // ... (previous handleInviteFriend logic remains the same)
  };
        ...
        <Card className="shadow-md">
          ...
          <CardContent>
            <div className="space-y-2">
              <Progress value={calculateProgress()} className="w-full h-3 rounded-full" />
                      ...
                      >
                        <div className="flex items-center space-x-3">
                          <Avatar className="h-10 w-10">
                            <AvatarImage src={`https://api.dicebear.com/6.x/initials/svg?seed=${referral}`} />
